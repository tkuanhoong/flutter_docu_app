        ...
        body: CustomScrollView(
          slivers: [
            SliverAppBar(
              ...
              pinned: true,
              // set floating to true will scroll out of view,
              // but it scrolls back into view when the user scrolls back in that direction
              // floating: true,
              // snaps the SliverAppBar in and out of view as the user scrolls
              // floating: true,
              // snap: true,
              // This adds to the size of the app bar and collapses as the user scrolls
              expandedHeight: 200.0,
              // fill the expanded height
              flexibleSpace: FlexibleSpaceBar(
                title: Text('Horizons'),
                // default colapseMode: pin; optional: pin & none
